...
import { filterAntartida, getAllActivities } from "../../redux/actions";
import { useEffect, useState } from "react";
import { Link } from "react-router-dom";

export default function FilterAntartida(props) {
    ...
    const getFilteredActivities = (searchActivity, countries) => {
        ...
        filterActivity = filterActivity[0].countries.filter((e) => e.continent === 'Antarctic')
    ...
    return (
        ...
        <main>
            ...
            ? "There are no countries in Antarctic with this activity" 
